...
@Component({
    selector: 'home-page',
    standalone: true,
    imports: [RouterOutlet, NavBarWithoutLogin, ultimateSale, Brands, DealsOfTheMonth, WomenCollection, FollowUsOnInstagram, ThisIsWhatOurCustomersSay, SubscribeToOurNewslatter],
